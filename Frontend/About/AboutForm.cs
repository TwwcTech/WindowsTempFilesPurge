namespace WindowsTempFilesPurge.Frontend.About
{
    public partial class AboutForm : Form
    {
        ...
        {
            AboutLabel.Text = "Windows Temp Files Purge is a utility designed to help users maintain " +
                "\ntheir digital hygiene by purging unnecessary temporary files that often clutter up storage space. " +
